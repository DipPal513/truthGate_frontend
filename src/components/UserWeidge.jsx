  ...
  return (
    ...
    >
      <div className="flex items-center gap-x-2">
        <div className="img w-14 flex items-center justify-center h-14  rounded-full  border">
          <img src={avatar?.url} alt="" className="rounded-full w-12 h-12 object-contain"/>
        </div>
